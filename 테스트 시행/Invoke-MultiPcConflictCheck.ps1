...
$serverFilter = @(
    'FullyQualifiedName~DirectCrudConcurrencyTests',
    'FullyQualifiedName~SyncControllerTests.Push_ReturnsConflict_WhenCustomerExpectedRevisionDoesNotMatch',
    'FullyQualifiedName~SyncControllerTests.Push_RejectsStaleCustomerUpdate_WhenServerRevisionIsNewerEvenIfIncomingTimestampIsLater',
    'FullyQualifiedName~SyncControllerTests.Push_ReturnsConflict_WhenInvoiceServerVersionIsNewer',
    'FullyQualifiedName~SyncControllerTests.Push_RejectsStaleItemWarehouseStockExpectedRevision',
    'FullyQualifiedName~SyncControllerTests.ConflictLogsController_HidesResolvedByDefault_AndResolveMarksStatus'
) -join '|'
$desktopFilter = @(
    'FullyQualifiedName~LocalStateServicePartialsTests.DeleteInvoiceAsync_RejectsStaleExpectedRevision',
    'FullyQualifiedName~LocalStateServicePartialsTests.CustomerContractMutations_RejectStaleExpectedRevision',
    'FullyQualifiedName~LocalStateServicePartialsTests.TransactionAttachmentMutations_RejectStaleExpectedRevision',
...
Write-Host "Multi-PC conflict regression check: $overall"
