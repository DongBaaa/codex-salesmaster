...
### 현재 소스·테스트판
- `[로컬검증]` Windows PC 현재 소스 `1.1.701`, FileVersion `1.1.701.0`이며 공개 stable과 일치합니다.
...
- 현재 소스 `1.1.701`의 정식 패키지 생성과 Linux PC live 반영을 완료했습니다. 현재 공개 stable ZIP SHA-256은 `5947801C7B558E3764C51C2D4EA6F492651B95D7E2D47BD5F9051DCC97C6ABD2`입니다.
