...
internal static class DesktopUpgradeRequiredResponseParser
{
    ...
    public static async Task<DesktopClientUpgradeRequiredException>
            ...
            CancellationToken ct = default)
    {
        ...
        return new DesktopClientUpgradeRequiredException(
            requestPath,
            response);
    }

    internal static async Task<ClientUpgradeRequiredResponse>
        ...
        ClientUpgradeRequiredResponse parsed)
    {
        ...
        return new ClientUpgradeRequiredResponse
        {
            ...
            Message =
                "The server requires a supported TradePlan desktop update.",
