...
public sealed class SyncOutboxListItem
{
    ...
    public DateTime PreparedAtLocal => PreparedAtUtc.ToLocalTime();
    ...
    public string ErrorMessageDisplay => DiagnosticUserMessageFormatter.DescribeOutboxError(ErrorMessage, Status);
}
