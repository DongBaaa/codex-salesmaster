...
public static class LocalMappings
{
    ...
    public static LocalCompanyProfile ToLocal(CompanyProfileDto dto) => new()
    {
        ...
        FaxNumber = dto.FaxNumber ?? string.Empty,
        Email = dto.Email,
    ...
    public static LocalCustomer ToLocal(CustomerDto dto) => new()
    {
        ...
        PriceGrade = string.IsNullOrWhiteSpace(dto.PriceGrade) ? "매출단가" : dto.PriceGrade.Trim(),
        Notes = dto.Notes,
    ...
    public static LocalInvoice ToLocal(InvoiceDto dto) => new()
    {
        ...
        VatMode = InvoiceVatModes.Normalize(dto.VatMode),
        TaxInvoiceIssued = dto.TaxInvoiceIssued,
        PurchaseReceivingRequired = dto.PurchaseReceivingRequired,
        ...
        PurchaseReceivedAtUtc = dto.PurchaseReceivedAtUtc.HasValue ? EnsureUtc(dto.PurchaseReceivedAtUtc.Value) : null,
        PurchaseReceivedByUsername = dto.PurchaseReceivedByUsername,
        PurchaseReceivingOfficeCode = dto.PurchaseReceivingOfficeCode,
        PurchaseReceivingWarehouseCode = dto.PurchaseReceivingWarehouseCode,
        PurchaseReceivingMemo = dto.PurchaseReceivingMemo,
        Memo = dto.Memo,
        CreatedAtUtc = dto.CreatedAtUtc,
        UpdatedAtUtc = dto.UpdatedAtUtc,
        Revision = dto.Revision,
    ...
    public static InvoiceDto ToDto(LocalInvoice e) => new()
    {
        ...
        VatMode = InvoiceVatModes.Normalize(e.VatMode),
        TaxInvoiceIssued = e.TaxInvoiceIssued,
        PurchaseReceivingRequired = e.PurchaseReceivingRequired,
        PurchaseReceivingStatus = InvoiceReceivingStatuses.Normalize(
            e.PurchaseReceivingStatus,
            e.VoucherType == VoucherType.Purchase,
            e.PurchaseReceivingRequired),
        PurchaseReceivedAtUtc = e.PurchaseReceivedAtUtc.HasValue ? EnsureUtc(e.PurchaseReceivedAtUtc.Value) : null,
        PurchaseReceivedByUsername = e.PurchaseReceivedByUsername,
        PurchaseReceivingOfficeCode = e.PurchaseReceivingOfficeCode,
        PurchaseReceivingWarehouseCode = e.PurchaseReceivingWarehouseCode,
        PurchaseReceivingMemo = e.PurchaseReceivingMemo,
        Memo = e.Memo,
        CreatedAtUtc = e.CreatedAtUtc,
        UpdatedAtUtc = e.UpdatedAtUtc,
        Revision = e.Revision,
    ...
    public static LocalRentalBillingProfile ToLocal(RentalBillingProfileDto dto) => new()
    {
        ...
        BillingDayMode = dto.BillingDayMode,
        BillingCycleMonths = dto.BillingCycleMonths,
        BillingAnchorMonth = dto.BillingAnchorMonth,
        DocumentIssueMode = dto.DocumentIssueMode,
        DocumentLeadDays = dto.DocumentLeadDays,
        ...
        PoolMeterAllowance = dto.PoolMeterAllowance,
        IsActive = dto.IsActive,
        CreatedAtUtc = EnsureUtc(dto.CreatedAtUtc),
        UpdatedAtUtc = EnsureUtc(dto.UpdatedAtUtc),
        Revision = dto.Revision,
    ...
    public static RentalBillingProfileDto ToDto(LocalRentalBillingProfile e) => new()
    {
        ...
        BillingDayMode = e.BillingDayMode,
        BillingCycleMonths = e.BillingCycleMonths,
        BillingAnchorMonth = e.BillingAnchorMonth,
        DocumentIssueMode = e.DocumentIssueMode,
        DocumentLeadDays = e.DocumentLeadDays,
        ...
        PoolMeterAllowance = e.PoolMeterAllowance,
        IsActive = e.IsActive,
        CreatedAtUtc = EnsureUtc(e.CreatedAtUtc),
        UpdatedAtUtc = EnsureUtc(e.UpdatedAtUtc),
        Revision = e.Revision,
    ...
    public static LocalRentalAsset ToLocal(RentalAssetDto dto) => new()
    {
        ...
        LastCustomerName = dto.LastCustomerName,
        LastInstallLocation = dto.LastInstallLocation,
        LastBillingProfileId = dto.LastBillingProfileId,
        LastBillingProfileDisplay = dto.LastBillingProfileDisplay,
        LastAssignmentClearedAtUtc = dto.LastAssignmentClearedAtUtc.HasValue ? EnsureUtc(dto.LastAssignmentClearedAtUtc.Value) : null,
        ...
        MeterBillingEnabled = dto.MeterBillingEnabled,
        BlackIncludedMode = RentalMeterPolicyModes.Normalize(dto.BlackIncludedMode, dto.BlackIncludedPages),
        BlackIncludedPages = dto.BlackIncludedPages,
        BlackOverageUnitPrice = dto.BlackOverageUnitPrice,
        ColorIncludedMode = RentalMeterPolicyModes.Normalize(dto.ColorIncludedMode, dto.ColorIncludedPages),
        ColorIncludedPages = dto.ColorIncludedPages,
        ColorOverageUnitPrice = dto.ColorOverageUnitPrice,
        MeterReadingsJson = RentalMeterBillingRules.SerializeReadings(RentalMeterBillingRules.ParseReadings(dto.MeterReadingsJson)),
        MeterEvidenceJson = string.IsNullOrWhiteSpace(dto.MeterEvidenceJson) ? "[]" : dto.MeterEvidenceJson,
        MeterPolicySource = dto.MeterPolicySource,
        MeterPolicySourceUpdatedAtUtc = dto.MeterPolicySourceUpdatedAtUtc.HasValue ? EnsureUtc(dto.MeterPolicySourceUpdatedAtUtc.Value) : null,
        OfficeCode = NormalizeOwningOfficeCode(dto.OfficeCode, dto.ResponsibleOfficeCode, DomainConstants.OfficeUsenet),
        ResponsibleOfficeCode = NormalizeResponsibleOfficeCode(dto.ResponsibleOfficeCode, dto.OfficeCode, DomainConstants.OfficeUsenet),
        AssetStatus = RentalAssetStatusNormalizer.Normalize(dto.AssetStatus),
        Notes = dto.Notes,
        CreatedAtUtc = EnsureUtc(dto.CreatedAtUtc),
        UpdatedAtUtc = EnsureUtc(dto.UpdatedAtUtc),
        Revision = dto.Revision,
    ...
    public static RentalAssetDto ToDto(LocalRentalAsset e) => new()
    {
        ...
        LastCustomerName = e.LastCustomerName,
        LastInstallLocation = e.LastInstallLocation,
        LastBillingProfileId = e.LastBillingProfileId,
        LastBillingProfileDisplay = e.LastBillingProfileDisplay,
        LastAssignmentClearedAtUtc = e.LastAssignmentClearedAtUtc.HasValue ? EnsureUtc(e.LastAssignmentClearedAtUtc.Value) : null,
        ...
        MeterBillingEnabled = e.MeterBillingEnabled,
        BlackIncludedMode = RentalMeterPolicyModes.Normalize(e.BlackIncludedMode, e.BlackIncludedPages),
        BlackIncludedPages = e.BlackIncludedPages,
        BlackOverageUnitPrice = e.BlackOverageUnitPrice,
        ColorIncludedMode = RentalMeterPolicyModes.Normalize(e.ColorIncludedMode, e.ColorIncludedPages),
        ColorIncludedPages = e.ColorIncludedPages,
        ColorOverageUnitPrice = e.ColorOverageUnitPrice,
        MeterReadingsJson = RentalMeterBillingRules.SerializeReadings(RentalMeterBillingRules.ParseReadings(e.MeterReadingsJson)),
        MeterEvidenceJson = string.IsNullOrWhiteSpace(e.MeterEvidenceJson) ? "[]" : e.MeterEvidenceJson,
        MeterPolicySource = e.MeterPolicySource,
        MeterPolicySourceUpdatedAtUtc = e.MeterPolicySourceUpdatedAtUtc.HasValue ? EnsureUtc(e.MeterPolicySourceUpdatedAtUtc.Value) : null,
        AssetStatus = RentalAssetStatusNormalizer.Normalize(e.AssetStatus),
        Notes = e.Notes,
        CreatedAtUtc = EnsureUtc(e.CreatedAtUtc),
        UpdatedAtUtc = EnsureUtc(e.UpdatedAtUtc),
        Revision = e.Revision,
    ...
    public static LocalRentalAssetAssignmentHistory ToLocal(RentalAssetAssignmentHistoryDto dto) => new()
    {
        ...
        CustomerName = dto.CustomerName,
        InstallLocation = dto.InstallLocation,
        BillingProfileDisplay = dto.BillingProfileDisplay,
        ItemName = dto.ItemName,
        MachineNumber = dto.MachineNumber,
        ManagementNumber = dto.ManagementNumber,
        MonthlyFee = dto.MonthlyFee,
        ...
        CreatedAtUtc = EnsureUtc(dto.CreatedAtUtc == default ? dto.LinkedAtUtc : dto.CreatedAtUtc),
        UpdatedAtUtc = EnsureUtc(dto.UpdatedAtUtc == default ? (dto.UnlinkedAtUtc ?? dto.LinkedAtUtc) : dto.UpdatedAtUtc),
        Revision = dto.Revision,
        IsDeleted = dto.IsDeleted,
        IsDirty = false
    };

    public static RentalAssetAssignmentHistoryDto ToDto(LocalRentalAssetAssignmentHistory e) => new()
    {
        Id = e.Id,
        TenantCode = NormalizeOperationalTenantCode(e.TenantCode, e.ResponsibleOfficeCode, e.ResponsibleOfficeCode),
        OfficeCode = NormalizeOwningOfficeCode(null, e.ResponsibleOfficeCode, DomainConstants.OfficeUsenet),
        ResponsibleOfficeCode = NormalizeResponsibleOfficeCode(e.ResponsibleOfficeCode, null, DomainConstants.OfficeUsenet),
        AssetId = e.AssetId,
        BillingProfileId = e.BillingProfileId,
        CustomerId = e.CustomerId,
        CustomerName = e.CustomerName,
        InstallLocation = e.InstallLocation,
        BillingProfileDisplay = e.BillingProfileDisplay,
        ItemName = e.ItemName,
        MachineNumber = e.MachineNumber,
        ManagementNumber = e.ManagementNumber,
        MonthlyFee = e.MonthlyFee,
        ...
        LinkedAtUtc = EnsureUtc(e.LinkedAtUtc),
        UnlinkedAtUtc = e.UnlinkedAtUtc.HasValue ? EnsureUtc(e.UnlinkedAtUtc.Value) : null,
        CreatedAtUtc = EnsureUtc(e.CreatedAtUtc),
        UpdatedAtUtc = EnsureUtc(e.UpdatedAtUtc),
        Revision = e.Revision,
        IsDeleted = e.IsDeleted
