...
public static partial class LocalDbInitializer
{
    ...
    private static bool MergeBillingTemplateIntoCanonical(
        LocalRentalBillingProfile canonical,
        LocalRentalBillingProfile sourceProfile,
        IReadOnlyList<LocalRentalAsset> sourceAssets)
    {
    ...
    private static bool ClearObsoleteProfileFields(LocalRentalBillingProfile profile)
        => false;

    private static bool ClearObsoleteAssetFields(LocalRentalAsset asset)
        => false;
