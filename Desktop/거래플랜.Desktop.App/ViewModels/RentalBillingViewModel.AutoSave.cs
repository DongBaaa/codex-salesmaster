    ...
    private void ApplyBillingEditorDraft(RentalBillingEditorDraftModel draft)
    {
        ...
        foreach (var assetLinkEdit in draft.AssetLinkEdits ?? Enumerable.Empty<RentalBillingAssetLinkEdit>())
        {
            ...
            _pendingAssetLinkEdits[assetLinkEdit.AssetId] = new RentalBillingAssetLinkEdit
            {
                ...
                ItemCategoryName = assetLinkEdit.ItemCategoryName,
                Manufacturer = assetLinkEdit.Manufacturer,
                ItemName = assetLinkEdit.ItemName,
                MachineNumber = assetLinkEdit.MachineNumber,
                PurchaseVendor = assetLinkEdit.PurchaseVendor,
                PurchasePrice = assetLinkEdit.PurchasePrice,
                SalePrice = assetLinkEdit.SalePrice,
                AssetStatus = assetLinkEdit.AssetStatus,
                BillingEligibilityStatus = assetLinkEdit.BillingEligibilityStatus,
                BillingExclusionReason = assetLinkEdit.BillingExclusionReason,
                DepositText = assetLinkEdit.DepositText,
                MonthlyFee = assetLinkEdit.MonthlyFee,
                ContractMonths = assetLinkEdit.ContractMonths,
                ContractDate = assetLinkEdit.ContractDate,
                ContractStartDate = assetLinkEdit.ContractStartDate,
                RentalEndDate = assetLinkEdit.RentalEndDate,
                PurchaseDate = assetLinkEdit.PurchaseDate,
                DisposalDate = assetLinkEdit.DisposalDate,
                InstallDate = assetLinkEdit.InstallDate,
                FreeSupplyItems = assetLinkEdit.FreeSupplyItems,
                PaidSupplyItems = assetLinkEdit.PaidSupplyItems,
